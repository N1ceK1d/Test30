...
INSERT INTO ResultsTexts (result_points, result_text)
VALUES 
('5 баллов и меньше, то:', 'В  компании  плохое  управление  персоналом  и  наймом.  Вам  срочно  нужно  менять  подход. Возможности  роста  и  развития  компании  ограничены.  В  компании  большие  потери  и  недостаток  дохода.'), 
('6 - 10 баллов, то:', 'В  компании  слабое  управление  персоналом  и  наймом.  Нужны  безотлагательные  действия  по  улучшению. Компания  теряет  возможности  дохода.'), 
('11 - 15 баллов, то:', 'В  компании  трудности  в  управлении  персоналом  и  наймом. Нужно  изменить  подход  к  управлению. Компания  теряет  больше,  чем  могла  бы  зарабатывать'), 
('16-20 баллов, то:', 'В  компании  дела  с  управлением  персоналом  и  наймом  обстоят  не  лучшим  образом.  Компания теряет не  мало  денег  на  недостатках  в  управлении  персоналом. Измените  подход  для  возможности  роста  и  развития  компании.'), 
('21 - 25 баллов, то:', 'В  компании  не  плохо  обстоят  дела  с  наймом  и  управлением  персоналом. Но  вы  не  используете  хорошие  возможности  и  инструменты  управления,  которые  могут  значительно  увеличить  компании  доход,  возможности  роста  и  развития.'), 
('26 баллов и больше, то:', 'В  вашей  компании  персонал  хорошо  управляем  и  компания  не  испытывает  проблем  с  наймом. На  вас  можно  ровняться  другим!');